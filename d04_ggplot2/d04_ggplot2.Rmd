...
- Construct layered plots using ggplot2's grammar (data + aesthetics + geoms)
- Map variables to aesthetics and distinguish mapping from setting
- Use faceting to explore conditional relationships in data
- Create publication-ready plots with proper labels and scales
...
.pull-left[
### Understanding
- ✅ ggplot2's layered grammar
- ✅ Mapping vs. setting aesthetics
]

.pull-right[
### Skills
- ✅ Build complex plots with layers
- ✅ Use faceting effectively
