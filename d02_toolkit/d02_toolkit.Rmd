...
- Define reproducibility in data analysis and explain its importance
- Use R and RStudio for basic data analysis tasks
- Create and knit R Markdown documents that integrate code, narrative, and output
...
.pull-left[
### Concepts
- ✅ Define reproducibility in data analysis
- ✅ Understand the toolkit: R, RStudio, R Markdown, Git/GitHub
]

.pull-right[
### Skills
- ✅ Use R and RStudio basics
