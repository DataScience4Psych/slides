...
So far, each variable we've simulated has been independent. But real data has **structure** — variables are correlated.
...
.question[
What does the covariance matrix represent? How would you interpret these results?
]

--

.tip[
Next time, we'll go deeper: building full correlation structures, power analysis by simulation, and understanding the Central Limit Theorem — all through simulation.
]
...
.pull-right[
### Skills
- ✅ Generate from normal, uniform, Poisson
- ✅ Create datasets with `rep()` and `rnorm()`
