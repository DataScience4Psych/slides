...
- Execute bootstrap resampling with replacement to estimate sampling distributions
- Calculate confidence intervals from bootstrap distributions at various levels
- Explain the relationship between confidence level, precision, and interval width
- Apply bootstrap techniques to any sample statistic (mean, median, etc.)
