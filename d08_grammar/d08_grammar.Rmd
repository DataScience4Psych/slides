...
- Use the pipe operator (`%>%`) to chain multiple dplyr functions
- Apply dplyr verbs (select, arrange, slice, filter) to subset and reorder data
- Construct complex filtering conditions using logical operators
- Explain dplyr's design principles and when to use piping
...
- ✅ dplyr design principles
]

.pull-right[
### Skills
- ✅ Use pipe operator for chaining
- ✅ Apply select, arrange, slice, filter
