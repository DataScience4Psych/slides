...
- Conduct exploratory data analysis and explain why visualization matters
- Describe the Grammar of Graphics framework
- Interpret and create basic visualizations using ggplot2
- Understand dataset structure (observations, variables, values)
