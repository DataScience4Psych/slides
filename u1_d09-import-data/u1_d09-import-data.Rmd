...
.your-turn[
- [class git repo](https://github.com/DataScience4Psych) > `AE 07 - Nobels and sales + Data import` > open `nobels-csv.Rmd` and knit.
...
.your-turn[
- [class git repo](https://github.com/DataScience4Psych) > `AE 07 - Nobels and sales + Data import` > open `food-excel.Rmd` and knit. Work on **Exercise 1**.
...
.your-turn[
- [class git repo](https://github.com/DataScience4Psych) > `AE 07 - Nobels and sales + Data import` > open `food-excel.Rmd` and knit. Work on **Exercise 2**.
...
.pull-left[
.your-turn[
- [class git repo](https://github.com/DataScience4Psych) > `AE 07 - Nobels and sales + Data import` > open `sales-excel.Rmd` and knit. 
