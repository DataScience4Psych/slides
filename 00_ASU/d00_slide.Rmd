...
- **Origins:** Launched in 2008, GitHub began as a platform for software developers to collaborate on code.
- **Evolution:** Over the years, GitHub has grown into a vast community where millions share, develop, and maintain software.
- **Beyond Code:** GitHub's use has expanded beyond software development to include academics, writers, and researchers who collaborate on various projects.
- **Features:** Offers version control with Git, issue tracking, project boards, and a platform for project management and collaboration
- **In Education:** GitHub Classroom and _free_ educational accounts bolster its use in teaching and learning.

- GitHub's unique blend of features supports not just coding projects but also the collaborative and iterative nature of academic research and teaching.

---
# What is Git? What is GitHub?

- **Git:** A version control system that tracks changes in files and facilitates collaborative work on projects. Git runs locally on your computer, allowing you to manage your project's history.
- **GitHub:** A web-based platform built on top of Git. It hosts your repositories online, making it easier to share your projects with others. GitHub adds a layer of social networking, issue tracking, project boards, and more to your Git projects.
- **Synergy:** While Git manages your project history locally, GitHub takes it to the cloud, enabling collaboration across teams globally. Together, they streamline project workflows and enhance productivity.

Using Git and GitHub together combines the power of version control with the ease of online collaboration.
---
...
## GitHub Actions
- Automate your workflow from idea to production with CI/CD pipelines directly in GitHub.

## Project Boards
- Plan and track your work and workflows with customizable project boards.

## GitHub Pages
- Host and publish your projects, documentation, or portfolio directly from your GitHub repository.
