---
title: "Models with multiple predictors<br> `r emo::ji('men_with_bunny_ears')`"
...
- Build and interpret models with multiple predictors
- Distinguish between main effects and interaction effects
- Use adjusted R-squared for comparing models
...
- This model implies that the regression coefficient for an explanatory variable would change as another explanatory variable changes.
