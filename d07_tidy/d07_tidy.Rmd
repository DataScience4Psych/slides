...
- Identify characteristics of tidy data and recognize common untidy patterns
- Distinguish between data frames and tibbles and their advantages
- Apply principles of displaying vs. summarizing data appropriately
- Evaluate data structure choices based on consistency and predictability
...
.pull-right[
### Skills
- ✅ Recognize untidy patterns
- ✅ Work with tibbles
- ✅ Display and summarize data appropriately
]
