...
- Evaluate ethical concerns in data causality claims and misrepresentation
- Detect manipulation in visualizations (axes, scales, maps, area distortion)
- Assess privacy violations and data re-identification risks
- Visualize uncertainty appropriately in data presentations
...
.pull-left[
### Ethical Awareness
- ✅ Recognize misrepresentation
- ✅ Detect visualization manipulation
...
- ✅ Identify data re-identification risks
