...
- APIs return data in a consistent, machine-readable format (JSON, XML)

--

- The data format is documented and maintained by the provider
...
- You get exactly the data you need, no parsing HTML

--

- Using an API respects the data provider's terms of service
