...
---
## Taking another⁵ look: Density Estimate+
```{r echo=TRUE}
...
Grammar of graphics is a tool to efficiently describe the components of a graphic
...
# Wrapping Up... Visualizing Star Wars
