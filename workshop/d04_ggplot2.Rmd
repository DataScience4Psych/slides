...
.pull-left[
```{r penguins2-0, fig.show="hide", warning=FALSE}
ggplot(data = penguins) #<<
```
]
.pull-right[
```{r ref.label = "penguins2-0", echo = FALSE, warning = FALSE, out.width = "100%", fig.width = 8}
```
]
...
.pull-left[
```{r penguins2-1, fig.show = "hide", warning = FALSE}
ggplot(data = penguins,
       mapping = aes(x = bill_depth_mm)) #<<
```
]
.pull-right[
```{r ref.label = "penguins2-1", echo = FALSE, warning = FALSE, out.width = "100%", fig.width = 8}
```
]
...
.pull-left[
```{r penguins2-2, fig.show = "hide", warning = FALSE}
ggplot(data = penguins,
       mapping = aes(x = bill_depth_mm,
                     y = bill_length_mm)) #<<
```
...
.pull-right[
```{r ref.label = "penguins2-2", echo = FALSE, warning = FALSE, out.width = "100%", fig.width = 8}
```
]
...
.pull-left[
```{r penguins2-3, fig.show = "hide", warning = FALSE}
ggplot(data = penguins,
       mapping = aes(x = bill_depth_mm,
                     y = bill_length_mm)) + 
  geom_point() #<<
...
.pull-right[
```{r ref.label = "penguins2-3", echo = FALSE, warning = FALSE, out.width = "100%", fig.width = 8}
```
]
...
.pull-left[
```{r penguins2-4, fig.show = "hide", warning = FALSE}
ggplot(data = penguins,
       mapping = aes(x = bill_depth_mm,
                     y = bill_length_mm,
                     color = species)) + #<<
...
.pull-right[
```{r ref.label = "penguins2-4", echo = FALSE, warning = FALSE, out.width = "100%", fig.width = 8}
```
]
...
.pull-left[
```{r penguins2-5, fig.show = "hide", warning = FALSE}
ggplot(data = penguins,
       mapping = aes(x = bill_depth_mm,
                     y = bill_length_mm,
                     color = species)) +
...
.pull-right[
```{r ref.label = "penguins2-5", echo = FALSE, warning = FALSE, out.width = "100%", fig.width = 8}
```
]
...
.pull-left[
```{r penguins2-6, fig.show = "hide", warning = FALSE}
ggplot(data = penguins,
       mapping = aes(x = bill_depth_mm,
                     y = bill_length_mm,
                     color = species)) +
...
.pull-right[
```{r ref.label = "penguins2-6", echo = FALSE, warning = FALSE, out.width = "100%", fig.width = 8}
```
]
...
.pull-left[
```{r penguins2-7, fig.show = "hide", warning = FALSE}
ggplot(data = penguins,
       mapping = aes(x = bill_depth_mm,
                     y = bill_length_mm,
                     color = species)) +
...
.pull-right[
```{r ref.label = "penguins2-7", echo = FALSE, warning = FALSE, out.width = "100%", fig.width = 8}
```
]
...
.pull-left[
```{r penguins2-8, fig.show = "hide", warning = FALSE}
ggplot(data = penguins,
       mapping = aes(x = bill_depth_mm,
                     y = bill_length_mm,
                     color = species)) +
...
.pull-right[
```{r ref.label = "penguins2-8", echo = FALSE, warning = FALSE, out.width = "100%", fig.width = 8}
```
]
...
.pull-left[
```{r penguins2-9, fig.show = "hide", warning = FALSE}
ggplot(data = penguins,
       mapping = aes(x = bill_depth_mm,
                     y = bill_length_mm,
                     color = species)) +
...
.pull-right[
```{r ref.label = "penguins2-9", echo = FALSE, warning = FALSE, out.width = "100%", fig.width = 8}
```
]
...
.pull-left[
```{r penguins2-10, fig.show = "hide", warning = FALSE}
ggplot(data = penguins,
       mapping = aes(x = bill_depth_mm,
                     y = bill_length_mm,
                     color = species)) +
...
.pull-right[
```{r ref.label = "penguins2-10", echo = FALSE, warning = FALSE, out.width = "100%", fig.width = 8}
```
]
...
```{r facet, fig.show = "hide", warning = FALSE}
