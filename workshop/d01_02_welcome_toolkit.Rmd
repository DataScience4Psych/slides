...
```{r quickstart,echo=FALSE,out.width="10%"}
library(qrcode)
code <- qr_code("https://DataScience4Psych.github.io/DataScience4Psych/1801_workshop_quickstart.html")
plot(code)
```

.small[
.center[
[Workshop Quick Start](https://DataScience4Psych.github.io/DataScience4Psych/1801_workshop_quickstart.html)
]
]
