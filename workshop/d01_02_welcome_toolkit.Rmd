...
- I use genetically-informed designs to approach these questions, as the nature of my research are impractical for experiments.
...
library(qrcode)
code <- qr_code("https://github.com/DataScience4Psych/slides/tree/main/workshop")
plot(code)
```
<br>
Slides: [github.com/DataScience4Psych/slides/tree/main/workshop](https://github.com/DataScience4Psych/slides/tree/main/workshop)
]
