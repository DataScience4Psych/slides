...
- Many tools for visualizing data (R is one of them) exist, 
  - as do many approaches/systems within R for making data visualizations (**ggplot2** is one of them, and
...
states:
+ Alaska
+ The western and Rocky Mountain states .tiny[(California, Colorado, Washington, Wyoming, Hawaii, Utah, New Mexico, Nevada, Montana, Idaho, Arizona, Oregon)]
