---
title: "Welcome to Data Science <br> `r emo::ji('cat')`"
...
A - Although statistics and computer science $\ne$ data science, they are very closely related and have tremendous of overlap. Hence, this course is a great way to get comfortable with those topics. However this course is **not** your typical compsci course.
...
```{r fig.align="center", echo=FALSE, alt="The US of Bey", out.width="50%"}
