...
- Identify basic data types in R (logical, double, integer, character)
- Distinguish between explicit and implicit type coercion
- Recognize special values (NA, NaN, Inf) and their behavior
- Apply data classes (factors, dates, data frames) to real-world problems
...
- ✅ Type coercion (explicit/implicit)
...
- ✅ Apply appropriate data classes
