---
title: "Logistic regression<br> `r emo::ji('tree')`"
...
- This approach is a general way of addressing many problems in regression and the resulting models are called **generalized linear models (GLMs)**
