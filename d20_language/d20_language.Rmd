...
- Conceptualize models as mathematical functions describing relationships
- Interpret residuals and assess model fit
- Compare linear vs. non-linear modeling approaches
- Predict outcomes using response and explanatory variables
