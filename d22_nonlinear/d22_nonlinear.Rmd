...
- Identify model violations through residual plots and diagnostics
- Apply log transformations to linearize non-linear relationships
- Interpret slope coefficients from log-transformed models
- Evaluate when transformations improve model fit
