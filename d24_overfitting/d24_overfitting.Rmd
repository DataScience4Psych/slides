---
title: "Prediction and overfitting<br> `r emo::ji('running_man')`"
...
- Recognize underfitting, appropriate fit, and overfitting scenarios
- Split data into training and testing sets to prevent overfitting
- Fit logistic regression models for classification tasks
...
```{r echo=FALSE, out.width="80%", fig.width=10}
