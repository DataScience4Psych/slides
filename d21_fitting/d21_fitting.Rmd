...
- Specify, set, and fit linear regression models using tidymodels
- Interpret slope and intercept coefficients in context
- Apply least squares regression and residual analysis
- Distinguish between numerical and categorical explanatory variables
