...
- Design segmented bar plots to display categorical relationships
- Create violin and ridge plots for comparing numerical distributions across groups
- Apply coordinate transformations and positioning strategies to categorical plots
- Customize visualizations with appropriate labels and legends
...
.pull-left[
### Concepts
- ✅ Categorical data visualization principles
- ✅ Position and coordinate strategies
]

.pull-right[
### Skills
- ✅ Create bar plots, violin plots, ridge plots
