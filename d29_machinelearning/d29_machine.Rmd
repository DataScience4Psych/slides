...
At its core, a machine learning model aims to make predictions or decisions based on input data. This process involves learning patterns from past data to apply to new, unseen data.
...
.pull-right[
```{r}
knitr::include_graphics("../img/sonar_signals_explained.png")
```
]
...
```{r}
knitr::include_graphics("../img/evaluation_metrics.png")
```
]
...
```{r echo=FALSE, fig.align = "left",caption="DALLE rendition of Comparison Chart of Learning Types: This chart visually compares supervised, unsupervised, and reinforcement learning"}
...
- These models make predictions or decisions without being explicitly programmed for the task.
...
# Preprocessing: centering and scaling the numeric attributes
.pull-left[
...
preProcess(): Prepares the data for modeling by centering and scaling.
...
.pull-left[
```{r}
knitr::include_graphics("../img/confusion_matrix_detailed.png")
```
]
