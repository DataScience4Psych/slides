...
- Write reusable functions with clear inputs, bodies, and return values
- Map functions over data structures using purrr
- Automate repetitive tasks through function creation and iteration
- Understand function environments, scoping, and naming best practices
...
.pull-left[
### Concepts
- ✅ Function structure (inputs, body, return)
