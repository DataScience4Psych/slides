---
title: "Quantifying uncertainty<br> `r emo::ji('shrug')`"
...
- Quantify variability in slope estimates using resampling
- Interpret confidence intervals in the context of population parameters
- Apply bootstrapping to estimate standard errors of regression coefficients
...
ggplot(elmhurst, aes(x = family_income, y = gift_aid)) +
  ...
  labs(
    ...
    subtitle = "Random sample 50 students at Elmhurst University"
  )
```
]
.footnote[
...
ggplot(elmhurst, aes(x = family_income, y = gift_aid)) +
  ...
  geom_text(x = 200, y = 40, label = paste("slope =", elmhurst_slope_obs), size = 6, hjust = 0)  +
  labs(
    x = "Family Income",
    y = "Gift Aid",
    title = "Gift aid and family income",
...
elmhurst_boot %>% 
  slice_head(n = 50) %>%
 mutate(data = map(splits, ~ analysis(.x))) %>%# hoist(splits,"data") %>% 
  unnest(data) %>% 
  ...
  scale_x_continuous(labels = label_dollar(suffix = "K"), limits = c(0, 275)) + 
  scale_y_continuous(labels = label_dollar(suffix = "K"), limits = c(0, 42)) +
  geom_text(x = 200, y = 40, label = paste("slope = ?"), size = 6, hjust = 0)  +
  labs(
    x = "Family Income",
    y = "Gift Aid",
    title = "Gift Aid and Family Income",
    subtitle = "(Simulated) population of students at Elmhurst University"
  )
```
...
ggplot(elmhurtst_boot_1, aes(x = family_income, y = gift_aid)) +
  ...
  scale_x_continuous(labels = label_dollar(suffix = "K"), limits = c(0, 275)) + 
  scale_y_continuous(labels = label_dollar(suffix = "K"), limits = c(0, 42)) +
  geom_text(x = 200, y = 40, label = paste("slope =", elmhurtst_boot_1_slope), size = 6, hjust = 0)  +
  labs(
    x = "Family Income",
    y = "Gift Aid",
...
ggplot(elmhurtst_boot_2, aes(x = family_income, y = gift_aid)) +
  ...
  scale_x_continuous(labels = label_dollar(suffix = "K"), limits = c(0, 275)) + 
  scale_y_continuous(labels = label_dollar(suffix = "K"), limits = c(0, 42)) +
  geom_text(x = 200, y = 40, label = paste("slope =", elmhurtst_boot_2_slope), size = 6, hjust = 0)  +
  labs(
    x = "Family Income",
    y = "Gift Aid",
...
ggplot(elmhurtst_boot_3, aes(x = family_income, y = gift_aid)) +
  ...
  scale_x_continuous(labels = label_dollar(suffix = "K"), limits = c(0, 275)) + 
  scale_y_continuous(labels = label_dollar(suffix = "K"), limits = c(0, 42)) +
  geom_text(x = 200, y = 40, label = paste("slope =", elmhurtst_boot_3_slope), size = 6, hjust = 0)  +
  labs(
    x = "Family Income",
    y = "Gift Aid",
...
ggplot(elmhurtst_boot_4, aes(x = family_income, y = gift_aid)) +
  ...
  scale_x_continuous(labels = label_dollar(suffix = "K"), limits = c(0, 275)) + 
  scale_y_continuous(labels = label_dollar(suffix = "K"), limits = c(0, 42)) +
  geom_text(x = 200, y = 40, label = paste("slope =", elmhurtst_boot_4_slope), size = 6, hjust = 0)  +
  labs(
    x = "Family Income",
    y = "Gift Aid",
