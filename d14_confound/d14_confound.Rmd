...
# Climate change survey: A Conditional Probability Case Study
...
- `summarize()` peels off one layer of grouping by default, or you can specify a different behaviour
